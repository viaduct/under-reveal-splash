  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto">
        ...
        >
          {/* Tab Navigation */}
          <TabsList className="w-full bg-transparent border-b border-border rounded-none h-auto p-0 mb-6 md:mb-20 lg:mb-16 flex items-end justify-center md:gap-8 gap-4 overflow-x-auto scrollbar-hide">
            <TabsTrigger
              value="urbanlink"
          ...
          <TabsContent value="panorama" className="mt-0">
            <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-20 items-start md:items-center min-h-[550px] md:min-h-[400px]">
          ...
          <TabsContent value="urbanlink" className="mt-0">
            <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-20 items-start md:items-center min-h-[600px] md:min-h-[400px]">
              <div className="transition-all duration-1000 opacity-100 translate-x-0 text-left w-full md:w-auto">
                <div className="w-[200px] md:w-[300px]">
                  <h2 className="text-[31px] lg:text-[50px] leading-[100%] font-bold text-foreground mb-[4px] font-rift text-left">
                    URBANLINK
          ...
          <TabsContent value="aradnas" className="mt-0">
            <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-20 items-start md:items-center min-h-[350px] md:min-h-[400px]">
              <div className="transition-all duration-1000 opacity-100 translate-x-0 text-left w-full md:w-auto">
                <div className="w-[200px] md:w-[300px]">
                  <h2 className="text-[31px] lg:text-[50px] leading-[100%] font-bold text-foreground mb-[4px] font-rift text-left">
                    ARADNAS
          ...
          <TabsContent value="mars" className="mt-0">
            <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-20 items-start md:items-center min-h-[300px] md:min-h-[400px]">
              <div className="transition-all duration-1000 opacity-100 translate-x-0 text-left w-full md:w-auto">
                <div className="w-[200px] md:w-[300px]">
                  <h2 className="text-[31px] lg:text-[50px] leading-[100%] font-bold text-foreground mb-[4px] font-rift text-left">
                    MAR/S
