...
const P = ({ children, first }: { children: React.ReactNode; first?: boolean }) => (
  <p className={`text-muted-foreground text-sm md:text-base leading-relaxed${first ? "" : " mt-4"}`}>
    {children}
  </p>
);
...
const businesses: Business[] = [
  {
    ...
    body: (
      <>
        <P first>URBANLINK is an operating group of dedicated entities—launching and running partner-specific Super App ecosystems across fandom, IP, and culture.</P>
        <P><Bold>ARTIST SUPER APP ECOSYSTEMS</Bold><br />Operating partner-led platforms that unify fandom, content, and commerce.</P>
        <P><Bold>FRANCHISE IP COMMUNITY HUBS</Bold><br />The community home for stories across film, series, animation, and beyond—built for membership and monetization.</P>
        <P><Bold>CULTURE COMMERCE</Bold><br />Scaling talent-adopted culture brands through community momentum and drop-based commerce.</P>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <P first>Panorama provides an operating framework through which artists and IP expand across platforms, communities, and commerce</P>
        <P><Bold>RECORD DISTRIBUTION</Bold><br />Partnering with leading labels and platforms to support global release strategy, distribution, and promotion for artists.</P>
        <P><Bold>PUBLISHING & RIGHTS</Bold><br />Managing publishing across key territories to maximize royalty income and enable collaboration with world-class songwriters and producers.</P>
        <P><Bold>TOURING & LIVE</Bold><br />Working with top agencies, promoters, and venues to build world tours—optimizing routing, ticketing, and live revenue.</P>
        <P><Bold>CATALOGUE IP DEALS</Bold><br />Structuring catalogue transactions across master and publishing rights—including acquisitions, partnerships, and administration models—to unlock long-term royalty value.</P>
      </>
    ),
  },
  {
...
Designs the narrative, world-building, and structural pathways through which artist IP evolves and expands.`}</P>
  ...
  },
  {
    ...
    body: (
      <>
        <P first>MAR/S provides an open platform ecosystem centered on virtual artists and music, integrating content, commerce, and fandom.</P>
        <P><Bold>VIRTUAL ARTIST SUPER PLATFORM</Bold><br />{`Builds and operates a super platform environment where diverse virtual artists can actively perform and create.
...
Operates an ecosystem in which individual artist IP can grow independently while coexisting within the platform.`}</P>
      </>
    ),
  },
];
      ...
      <div className="w-full max-w-7xl mx-auto flex-1">
        ...
        >
          ...
          <div className="flex-1 flex items-center">
            {businesses.map((business) => (
              <TabsContent key={business.id} value={business.id} className="mt-0 w-full">
                    ...
                    <div className="w-full md:w-[300px]">
                      <div className="flex items-center justify-between md:block">
                        ...
                        <Button
                          ...
                          onClick={() => business.webpageUrl && window.open(business.webpageUrl, "_blank")}
                        >
                          WEBSITE
                          <ExternalLink className={`ml-1.5 h-3 w-3${business.webpageUrl ? " transition-transform group-hover:translate-x-1" : ""}`} />
                        </Button>
                      </div>
                      ...
                      >
                        WEBSITE
                        <ExternalLink className={`ml-2 h-4 w-4${business.webpageUrl ? " transition-transform group-hover:translate-x-1" : ""}`} />
                      </Button>
                    </div>
                  </div>
