  ...
  return (
    ...
    >
      ...
      <div className="w-full relative z-10 flex flex-col items-center">
        ...
        {/* DOCE OS Line Image */}
        <div
          className={`mt-16 w-screen relative left-1/2 right-1/2 -mx-[50vw] flex justify-start transition-all duration-1000 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
          style={{ transitionDelay: isVisible ? "900ms" : "0ms" }}
        >
          <img src={doceOsLineImage} alt="DOCE OS" className="w-full max-w-[1920px] h-auto object-cover" />
        </div>
      </div>
    </div>
  );
