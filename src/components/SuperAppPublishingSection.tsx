        ...
        <Tabs defaultValue="tab1" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="tab1" className="mt-0 w-full max-w-[1400px] mx-auto">
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
              ...
              {/* Right side - Images */}
              <div
                className={`flex gap-4 justify-center lg:justify-end transition-all duration-1000 h-[240px] lg:h-[350px] xl:h-[420px] ${
                  isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                }`}
          ...
          <TabsContent value="tab2" className="mt-0 w-full max-w-[1400px] mx-auto">
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
              ...
              {/* Right side - Logos */}
              <div
                className={`flex justify-center lg:justify-end transition-all duration-1000 h-[240px] lg:h-[350px] xl:h-[420px] ${
                  isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                }`}
                style={{ transitionDelay: isVisible ? "800ms" : "0ms" }}
              >
