...
const SuperAppPublishingSection = () => {
  ...
  return (
    <div
      ...
      ref={sectionRef}
      className="relative flex items-start md:items-center justify-center px-8 md:px-28 lg:px-40 xl:px-52 pt-8 md:pt-[140px] pb-20 min-h-[calc(100vh-48px)]"
      style={{
    ...
    >
      <div className="w-full relative z-10 flex flex-col items-center h-full">
        ...
        >
          ...
          <div
            className={`transition-all duration-1000 mb-[30px] lg:mb-12 flex-shrink-0 relative z-20 ${
              isVisible
          ...
          >
            <TabsList className="bg-transparent p-0 h-auto gap-8 mb-5 md:mb-16 flex justify-center items-center border-b border-border w-full rounded-none">
              <TabsTrigger
                value="tab1"
          ...
          <div className="flex-1 overflow-visible">
            <TabsContent
              value="tab1"
              className="mt-0 w-full max-w-[1000px] mx-auto"
            >
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center lg:items-start">
                ...
                {/* Right side - Images */}
                <div
                  className={`flex-1 flex justify-center lg:justify-end items-start transition-all duration-1000 mt-0 lg:mt-8 xl:-mt-24 ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-4"
                  }`}
                ...
                >
                  ...
                  <div className="space-y-4">
                    <p className="text-sm md:text-base leading-[1.6] text-foreground text-center lg:text-left">
                      ...
                      agencies based in Los Angeles and New York, building a
                      global entertainment infrastructure.
                    </p>
